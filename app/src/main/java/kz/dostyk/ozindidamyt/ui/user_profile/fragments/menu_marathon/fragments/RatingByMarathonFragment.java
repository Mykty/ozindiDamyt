...
public class RatingByMarathonFragment extends Fragment /*implements View.OnClickListener */{
    ...
    private ArrayList<MarathonRating> userList;
    private SearchView searchView;
    private View view;
    private ProgressBar progressBar;
    private MarathonRatingAdapter marathonRatingAdapter;
...
//        filterDialog();
    ...
    public void initView() {
        ...
        userList.add(new MarathonRating("Мақсат", "1", "150", ""));
        userList.add(new MarathonRating("Арлан", "2", "100", ""));
        userList.add(new MarathonRating("Қатипаш", "3", "50", ""));

        marathonRatingAdapter = new MarathonRatingAdapter(getActivity(), userList);
        recyclerView.setAdapter(marathonRatingAdapter);
