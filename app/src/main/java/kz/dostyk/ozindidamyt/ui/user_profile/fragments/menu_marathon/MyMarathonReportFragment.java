package kz.dostyk.ozindidamyt.ui.user_profile.fragments.menu_marathon;
...
import kz.dostyk.ozindidamyt.ui.user_profile.fragments.menu_marathon.fragments.MarathonReportFragment;
import kz.dostyk.ozindidamyt.ui.user_profile.fragments.menu_marathon.fragments.RatingByMarathonFragment;
...
public class MyMarathonReportFragment extends Fragment implements View.OnClickListener {
    private View root;
    private DatabaseReference databaseReference;

    @BindView(R.id.view_pager2) ViewPager2 viewPager;
    @BindView(R.id.bookTabLayout) TabLayout tabLayout;
    private String[] titles = new String[]{"Марафон репорт", "Рейтинг"};
    ...
    private class ViewPagerFragmentAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                case 0:
                    return new MarathonReportFragment();
                case 1:
                    return new RatingByMarathonFragment();
            }
