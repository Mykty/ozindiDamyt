package kz.dostyk.ozindidamyt.ui.user_profile.fragments.menu_quiz;
...
public class MyQuizzesFragment extends Fragment implements View.OnClickListener {
    private View root;
...
//        tabLayout.setupWithViewPager(viewPager);
    ...
    private String[] titles = new String[]{"Quiz нәтижелері", "Рейтинг"};
    ...
    private class ViewPagerFragmentAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                ...
                case 1:
                    return new RatingByQuizFragment();
            }
