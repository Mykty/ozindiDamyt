...
public class QuizRatingAdapter extends RecyclerView.Adapter<QuizRatingAdapter.MyTViewHolder> {
    ...
    public QuizRatingAdapter(Context context, ArrayList<User> userList) {
...
//        }
    ...
    public MyTViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rating_quz, parent, false);
