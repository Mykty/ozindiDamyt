...
public class MarathonRatingAdapter extends RecyclerView.Adapter<MarathonRatingAdapter.MyTViewHolder> {
    private Context context;
    public ArrayList<MarathonRating> userList;
    String currectUserPhoneNumber;

    public static class MyTViewHolder extends RecyclerView.ViewHolder {
        public TextView userPoint, info, userRating;
    ...
    public MarathonRatingAdapter(Context context, ArrayList<MarathonRating> userList) {
...
//        }
    ...
    public MyTViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_marathon_rating, parent, false);
    ...
    public void onBindViewHolder(final MyTViewHolder holder, int position) {
        MarathonRating item = userList.get(position);
