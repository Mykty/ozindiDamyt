...
public class RatingBySportFragment extends Fragment /*implements View.OnClickListener */{
    private DatabaseReference mDatabaseRef, ratingUserRef;
    private RecyclerView recyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private RecyclerView.LayoutManager linearLayoutManager;
    private ArrayList<User> userListCopy;
    private ArrayList<SportRating> userList;
    private SearchView searchView;
    private View view;
    private ProgressBar progressBar;
    private SportRatingAdapter sportRatingAdapter;
...
//        filterDialog();
    ...
    public void initView() {
        ...
        userList.add(new SportRating("Мақсат", "1", "150", "1 сағат 40 минут", ""));
        userList.add(new SportRating("Арлан", "2", "100", "50 минут", ""));
        userList.add(new SportRating("Қатипаш", "3", "50", "35 минут", ""));

        sportRatingAdapter = new SportRatingAdapter(getActivity(), userList);
        recyclerView.setAdapter(sportRatingAdapter);
