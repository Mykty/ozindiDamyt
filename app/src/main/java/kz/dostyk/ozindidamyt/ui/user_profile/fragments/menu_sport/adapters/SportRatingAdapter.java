...
public class SportRatingAdapter extends RecyclerView.Adapter<SportRatingAdapter.MyTViewHolder> {
    ...
    public SportRatingAdapter(Context context, ArrayList<SportRating> userList) {
...
//        }
    ...
    public MyTViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rating_sport, parent, false);
    ...
    public void onBindViewHolder(final MyTViewHolder holder, int position) {
        SportRating item = userList.get(position);
